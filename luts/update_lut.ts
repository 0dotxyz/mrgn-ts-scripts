...
const config: Config = {
  ...
  KEYS: [
    ...
    new PublicKey("CYXEgwbPHu2f9cY3mcUkinzDoDcsSan7myh1uBvYRbEw"),
    new PublicKey("DEkqHyPN7GMRJ5cArtQFAWefqbZb33Hyf6s5iCwjEonT"),
    new PublicKey("GFuW7dxmive4oVq4ehvLuprNuJFg8GpPz2BR3tNKtdUd"),
    new PublicKey("2SAsqyaN3CtW6qSXEVmvTQWbciuC31hz4KMHA8cRvyAH"),
    new PublicKey("CrhAjdTsX37buD33WgWQhbxLu5CKrWWYUar8zQkD959Y"),
    new PublicKey("HYPrHj5oCSMpmbqQGcbHNmudmVL9pzBT1sg18yo4fdb8"),
    new PublicKey("J3Lq3gueMBPmd7QLaSzEzx82AAbUkVb9wcaMUgQrzVt4"),
    new PublicKey("DL2Ss6C54dsXGvXS1MtfRZsR9ncjEBqSzTsgxRWdyHVR"),
    new PublicKey("JAYGerkPtynPYMY19ZPvPNGobLRPxjQaDWLRuepjVxTB"),
    new PublicKey("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA"),
    new PublicKey("11111111111111111111111111111111"),
    new PublicKey("4qp6Fx6tnZkY5Wropq9wUYgtFxXKwE6viZxFHg3rdAG8"),
    new PublicKey("CYXEgwbPHu2f9cY3mcUkinzDoDcsSan7myh1uBvYRbEw"),
    new PublicKey("GFuW7dxmive4oVq4ehvLuprNuJFg8GpPz2BR3tNKtdUd"),
    new PublicKey("DsrRnQVhZ8Bd5JRP4X6TJptmcjBfPhqBZCMa4DBATMjo"),
  ],
};

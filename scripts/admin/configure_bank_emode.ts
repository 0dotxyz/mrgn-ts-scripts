...
import { I80F48_ZERO } from "../utils/utils";
...
const BANK_KEYS: Record<EmodeTag, PublicKey[]> = {
  ...
  [EmodeTag.SOL]: [
    ...
    new PublicKey("4cSk2pyxFkPdc5Kp5Yk1HYLjTbNoYzwtz2MCKUogjqeg"), // Juplend SOL
  ],
  // Isolated Kamino markets take a 5% cut from the T1 above
  [EmodeTag.SOL_T2]: [
    new PublicKey("4uawSqEM2jDPKkQRtnoSTmBjFJ51Ehu79EvGfu3R45o7"), // Kamino Marinade SOL
    new PublicKey("J5mxC3hLXqmsJB4Nauf9YrtbNMSTHGz7FWfAmy1v6Fzr"), // Kamino Jito SOL
  ],
  ...
  [EmodeTag.LST_T2]: [
    ...
    new PublicKey("3Gm3ZbbPE7JnC5FxAgCj2i6pK22kjePa4y5NDVVENnjr"), // cgntSOL
    new PublicKey("4ecRL7M2fdmWjZd81PTZ9Sqg1e47ZpiwhkeDbsBJtqax"), // corvusSOL
  ...
  [EmodeTag.STABLE_T1]: [
    ...
    new PublicKey("3xn7strvpinirQ5KxEgVFemb6qYeHG39krohoeRHRrRt"), // JupUSD
    new PublicKey("27Cpv49jQ3hav8zF3qZjp7T78ATdUTZN4m9x389Z8uH4"), // Kamino Main USDC
    new PublicKey("6LoPoNHJKmQFE5ugVma19uGoM3kF1RsQUfGcem9UMLAk"), // Kamino USDC
    new PublicKey("EwURhaBfL9ahMqPHrJYpjaNsbXBWmwDxyLNXeudncF8N"), // Kamino USDC
    new PublicKey("VnVjbrytWcxTi6nCASMryKm4vHwpVZvwJetE2W1w5gB"),  // Kamino USDC
    new PublicKey("6kUpx1xVpRFwDR7oWqcr3t8YL7hiSGMThpT6FtbFxyL1"), // Kamino USDT
    new PublicKey("FLnBNuXqJYUNa8EwC1APQ4qV128f8iHQQ6vnr1PaD1ax"), // Kamino USDT
    new PublicKey("4VgNUPbdTNJ6a8NcLZDrjqtxpRk1fK7NDpMBSmvGVwHn"), // Kamino USDS
    new PublicKey("FLwQ2tV4gPHKWY1jwdB3Hp8Z18nU4WngvNgJn3qZVGd7"), // Kamino USDS
    new PublicKey("HWSRiriCeJ8MZEWaQWb5dtztjEtLTinu5EfjcXyT8RPv"), // Kamino USDS
    new PublicKey("6SUMngtaS1Bwzxj85EhaekWkZJ9uHrRQCap6MX6RFufW"), // Juplend USDT
    new PublicKey("8J7nwjQwKTFmx1FkhGN2YeKhMTC6r7kZnHAK8hLK7rLm"), // Juplend USDS
    new PublicKey("Be5LNsgq7Zs3LJkCnqW4j3bs7GsZksNNmqEiyEhbsugn"), // Juplend USDC
    new PublicKey("hLkUhGPbBUuiCUWRsBsXrWnWH95rH3HkRkNtR8vyA7k"),  // Juplend JupUSD
  ],
  [EmodeTag.STABLE_T2]: [
  ...
  [EmodeTag.PT_HYUSD]: [
    new PublicKey("6os7THfmjSXjxvZ488GNJAkTtTMY56vj1FfdDwocds6i"), // PT-hyusd
  ],
  [EmodeTag.HYUSD]: [
    new PublicKey("5syijTAMBBmdjwUgYYBvvv26zTS6YX1bYV9EdXkgYqLa"), // hyusd
  ],
};
...
const PAIR_TABLE: PairConfig[] = [
  ...
  { lend: EmodeTag.SOL, borrow: EmodeTag.SOL_T2, appIso: true, init: 0.95, maint: 0.99 }, 
  { lend: EmodeTag.SOL, borrow: EmodeTag.SOL, appIso: true, init: 0.95, maint: 0.99 }, 

  { lend: EmodeTag.SOL_T2, borrow: EmodeTag.LST_T1, appIso: true, init: 0.85, maint: 0.90 },
  { lend: EmodeTag.SOL_T2, borrow: EmodeTag.LST_T2, appIso: true, init: 0.80, maint: 0.90 },
  { lend: EmodeTag.SOL_T2, borrow: EmodeTag.SOL, appIso: true, init: 0.90, maint: 0.95 }, 
  { lend: EmodeTag.SOL_T2, borrow: EmodeTag.SOL_T2, appIso: true, init: 0.90, maint: 0.95 }, 

  { lend: EmodeTag.LST_T1, borrow: EmodeTag.SOL, appIso: true, init: 1.046, maint: 1.051 },
  { lend: EmodeTag.LST_T1, borrow: EmodeTag.SOL_T2, appIso: true, init: 0.95, maint: 0.99 }, // Note: current T2 banks are non-borrowable-from, so it's just theoretic 
  ...
  { lend: EmodeTag.LST_T2, borrow: EmodeTag.SOL_T2, appIso: true, init: 0.95, maint: 0.97 },
  ...
  { lend: EmodeTag.JLP, borrow: EmodeTag.SOL_T2, appIso: true, init: 0.85, maint: 0.90 },
  ...
  { lend: EmodeTag.LST_PT, borrow: EmodeTag.SOL_T2, appIso: true, init: 0.85, maint: 0.90 },
  ...
  { lend: EmodeTag.PT_HYUSD, borrow: EmodeTag.HYUSD, appIso: true, init: 0.9, maint: 0.95 },
];

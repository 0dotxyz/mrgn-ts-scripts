...
/**
 * (admin only) Enable SPL single-pool on-ramp lamports in staked-collateral oracle pricing for the
 * group. Used during the SVSP upgrade rollout so every staked oracle uses the canonical single-pool
 * NAV formula. Clears STAKED_ORACLE_DISABLED and sets STAKED_ORACLE_PRICE_USES_ONRAMP.
 */

...
const config: Config = {
  ...
  ORACLE: new PublicKey("FKw8kKKxvEBG9rzPG4Y7s6CnED7uNvc4HxUYsiJnegyS"),
  ORACLE_TYPE: ORACLE_TYPE_SWB,
  ADMIN: new PublicKey("CYXEgwbPHu2f9cY3mcUkinzDoDcsSan7myh1uBvYRbEw"),
  BANK_MINT: new PublicKey("AavE1kKKnesPw4MuRJmJ9jZs9QzEE8CPxQ3ViczUDfc1"),
  SEED: 0,
...
const bankConfig: BankConfig = {
  ...
  depositLimit: new BN(1_000 * 10 ** 8),
  interestRateConfig: rate,
  operationalState: { operational: {} },
  borrowLimit: new BN(1_000 * 10 ** 8),
  riskTier: { collateral: {} },

...
const config: Config = {
  ...
  ORACLE: new PublicKey("J7UPyPv7rzWxsr27gmmLjJXE9Wk9xui3swR7RZfyusaP"),
  ORACLE_TYPE: ORACLE_TYPE_SWB,
  ADMIN: new PublicKey("CYXEgwbPHu2f9cY3mcUkinzDoDcsSan7myh1uBvYRbEw"),
  BANK_MINT: new PublicKey("98sMhvDwXj1RQi5c5Mndm3vPe9cBqPrbLaufMXFNMh5g"),
  SEED: 0,
...
const rate: InterestRateConfig1_7 = {
  ...
  points: [
    { util: utilToU32(0.1), rate: aprToU32(0.05) },
    { util: utilToU32(0.5), rate: aprToU32(0.1) },
    { util: utilToU32(0.7), rate: aprToU32(0.15) },
    { util: utilToU32(0.9), rate: aprToU32(0.25) },
    { util: utilToU32(0.95), rate: aprToU32(0.35) },
    { util: utilToU32(0.97), rate: aprToU32(0.5) },
  ],
  curveType: 1,
};
...
const bankConfig: BankConfig = {
  ...
  depositLimit: new BN(17_000 * 10 ** 9),
  interestRateConfig: rate,
  operationalState: { operational: {} },
  borrowLimit: new BN(17_000 * 10 ** 9),
  riskTier: { collateral: {} },
